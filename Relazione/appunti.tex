...
% @errore tecnicamente Keras è una classe di tf, a volte viene considerata una libreria ho visto, fai tu 
...
\subsection{Images}
% @errore c'è una ripetizione (picture)
...
% @errore la cosa della risoluzione è gia stata detta (magari working with said resolution o qualcosa del genere?)
% @errore tall ==> toll
...
% @errore fine frase, exectu è un executed?
